<?php
/**
 * Barangay Documents Delivery System - Edit Profile Page
 */
require_once 'config.php';

$pageTitle = 'Edit Profile - Barangay Clearance Delivery System';
$pageBodyClass = 'profile-body';
        ...
        <div class="profile-container">
            ...
            <section class="profile-picture-section">
                ...
                <div class="profile-info">
                    ...
                    <p id="profilePhone">+63 912 345 6789</p>
                </div>
            </section>
                    ...
                    <div class="form-section">
                        ...
                        <div class="preference-item">
                            <div class="preference-info">
                                ...
                                <p>Receive SMS updates about your orders</p>
                            </div>
                            <label class="toggle-switch">
    ...
    <div class="message-overlay" id="messageOverlay" style="display: none;">
        <div class="message-box">
            ...
            <div class="message-content">
                ...
                <p id="messageText">Your profile has been updated successfully.</p>
            </div>
